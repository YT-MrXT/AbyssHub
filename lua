...
Tabs.Settings:AddButton({
    ...
    Callback=function()
        local codes = {
            "EASTEREXP", "LIGHTNINGABUSE", "1LOSTADMIN", "KITT_RESET",
            "SUB2GAMERROBOT_RESET1", "Sub2UncleKizaru", "SUB2GAMERROBOT_EXP1",
            "SUB2CAPTAINMAUI", "SUB2FER999", "Enyu_is_Pro", "MagicBUS",
            "JCWK", "StarcodeHEO", "KittGaming", "Sub2OfficialNoobie",
            "THEGREATACE", "SUB2NOOBMASTER123", "Sub2Daigrock", "Axiore",
            "StrawHatMaine", "TantaiGaming", "Bluxxy", "Bignews",
            "FUDD10", "fudd10_v2", "Chandler"
        }
        local remoteFunction = ReplicatedStorage:WaitForChild("Remotes"):WaitForChild("Redeem")
        ...
        Window:Notify({Title="Codes", Text="All codes redeemed!", Duration=4})
    end
})
